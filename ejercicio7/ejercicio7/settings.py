"""
Django settings for ejercicio7 project.
...
WSGI_APPLICATION = 'ejercicio7.wsgi.application'
...
LOGOUT_REDIRECT_URL = '/restaurantes/'  # The page you want users to arrive at after they successful log in
